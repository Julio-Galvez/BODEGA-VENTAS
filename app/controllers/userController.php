		...
		public function listarUsuarioControlador($pagina,$registros,$url,$busqueda){
			...
			$tabla.='
		        ...
		        <table class="table is-bordered is-striped is-narrow is-hoverable is-fullwidth">
		            <thead>
		                <tr style="background-color: #088395; color: white; border: 1px solid black;">
		                    <th class="has-text-centered" style="background-color: #088395; color: white; border: 1px solid white;">#</th>
		                    <th class="has-text-centered" style="background-color: #088395; color: white; border: 1px solid white;">Nombre</th>
		                    <th class="has-text-centered" style="background-color: #088395; color: white; border: 1px solid white;">Usuario</th>
		                    <th class="has-text-centered" style="background-color: #088395; color: white; border: 1px solid white;">Email</th>
		                    <th class="has-text-centered" style="background-color: #088395; color: white; border: 1px solid white;">Foto</th>
		                    <th class="has-text-centered" style="background-color: #088395; color: white; border: 1px solid white;">Actualizar</th>
		                    <th class="has-text-centered" style="background-color: #088395; color: white; border: 1px solid white;">Eliminar</th>
		                </tr>
		            </thead>
		            <tbody>
		    ';
				...
				foreach($datos as $rows){
					$tabla.='
						<tr class="has-text-centered" >
							<td style="background-color: #B3E8E5; color: black; border: 1px solid white;">'.$contador.'</td>
							<td style="background-color: #B3E8E5; color: black; border: 1px solid white;">'.$rows['usuario_nombre'].' '.$rows['usuario_apellido'].'</td>
							<td style="background-color: #B3E8E5; color: black; border: 1px solid white;">'.$rows['usuario_usuario'].'</td>
							<td style="background-color: #B3E8E5; color: black; border: 1px solid white;">'.$rows['usuario_email'].'</td>
