		...
		public function listarVentaControlador($pagina,$registros,$url,$busqueda){
			...
			$tabla.='
		        ...
		        <table class="table is-bordered is-striped is-narrow is-hoverable is-fullwidth">
		            <thead style="background-color: #088395; color: white;">
		                <tr style="background-color: #088395; color: white;">
		                    <th class="has-text-centered" style="background-color: #088395; color: white; border: 1px solid white;">N°</th>
		                    <th class="has-text-centered" style="background-color: #088395; color: white; border: 1px solid white;">Codigo</th>
		                    <th class="has-text-centered" style="background-color: #088395; color: white; border: 1px solid white;">Fecha</th>
		                    <th class="has-text-centered" style="background-color: #088395; color: white; border: 1px solid white;">Cliente</th>
		                    <th class="has-text-centered" style="background-color: #088395; color: white; border: 1px solid white;">Vendedor</th>
		                    <th class="has-text-centered" style="background-color: #088395; color: white; border: 1px solid white;">Total</th>
		                    <th class="has-text-centered" style="background-color: #088395; color: white; border: 1px solid white;">Opciones</th>
		                </tr>
		            </thead>
		            <tbody>
		    ';
				...
				foreach($datos as $rows){
					$tabla.='
						<tr class="has-text-centered">
							<td style="background-color: #B3E8E5; color: black; border: 1px solid white; ">'.$rows['venta_id'].'</td>
							<td style="background-color: #B3E8E5; color: black; border: 1px solid white; ">'.$rows['venta_codigo'].'</td>
							<td style="background-color: #B3E8E5; color: black; border: 1px solid white; ">'.date("d-m-Y", strtotime($rows['venta_fecha'])).' '.$rows['venta_hora'].'</td>
							<td style="background-color: #B3E8E5; color: black; border: 1px solid white; ">'.$this->limitarCadena($rows['cliente_nombre'].' '.$rows['cliente_apellido'],30,"...").'</td>
							<td style="background-color: #B3E8E5; color: black; border: 1px solid white; ">'.$this->limitarCadena($rows['usuario_nombre'].' '.$rows['usuario_apellido'],30,"...").'</td>
							<td style="background-color: #B3E8E5; color: black; border: 1px solid white; ">'.MONEDA_SIMBOLO.number_format($rows['venta_total'],MONEDA_DECIMALES,MONEDA_SEPARADOR_DECIMAL,MONEDA_SEPARADOR_MILLAR).' '.MONEDA_NOMBRE.'</td>
			                <td style="background-color: #B3E8E5; color: black; border: 1px solid white; ">
