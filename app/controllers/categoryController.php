		        ...
		        <table class="table is-bordered is-striped is-narrow is-hoverable is-fullwidth">
		            <thead style="background-color: #088395; color: white;">
		                <tr>
		                    ...
		                    <th class="has-text-centered" style="background-color: #088395; color: white; border: 1px solid white;">Ubicacion</th>
		                    <th class="has-text-centered" style="background-color: #088395; color: white; border: 1px solid white;">Productos</th>
				...
				foreach($datos as $rows){
					$tabla.='
						<tr class="has-text-centered" >
							...
							<td style="background-color: #B3E8E5; color: black; border: 1px solid white;">'.$rows['categoria_nombre'].'</td>
							<td style="background-color: #B3E8E5; color: black; border: 1px solid white;">'.$rows['categoria_ubicacion'].'</td>
