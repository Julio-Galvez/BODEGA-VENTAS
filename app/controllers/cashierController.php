			...
			$tabla.='
		        ...
		        <table class="table is-bordered is-striped is-narrow is-hoverable is-fullwidth">
		            <thead style="background-color: #088395; color: white;">
		                <tr>
		                    <th class="has-text-centered" style="background-color: #088395; color: white; border: 1px solid white;">Numero</th>
		                    <th class="has-text-centered" style="background-color: #088395; color: white;border: 1px solid white;">Nombre</th>
		                    <th class="has-text-centered" style="background-color: #088395; color: white;border: 1px solid white;">Efectivo</th>
				...
				foreach($datos as $rows){
					$tabla.='
						<tr class="has-text-centered" >
							<td style="background-color: #B3E8E5; color: black; border: 1px solid white;">'.$rows['caja_numero'].'</td>
							<td style="background-color: #B3E8E5; color: black; border: 1px solid white;">'.$rows['caja_nombre'].'</td>
							<td style="background-color: #B3E8E5; color: black; border: 1px solid white;"> S/. '.$rows['caja_efectivo'].'</td>
