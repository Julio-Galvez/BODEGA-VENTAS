		        ...
		        <table class="table is-bordered is-striped is-narrow is-hoverable is-fullwidth">
		            <thead style="background-color: #088395; color: white;">
		                <tr>
		                    ...
		                    <th class="has-text-centered" style="background-color: #088395; color: white; border: 1px solid white;">Documento</th>
				...
				foreach($datos as $rows){
					$tabla.='
						<tr class="has-text-centered" >
							...
							<td style="background-color: #B3E8E5; color: black; border: 1px solid white;">'.$rows['cliente_tipo_documento'].': '.$rows['cliente_numero_documento'].'</td>
							<td style="background-color: #B3E8E5; color: black; border: 1px solid white;">'.$rows['cliente_nombre'].' '.$rows['cliente_apellido'].'</td>
							<td style="background-color: #B3E8E5; color: black; border: 1px solid white;">'.$rows['cliente_email'].'</td>
